...
function renderAdmin(){
 ...
 if(state.tab==='critico'){
  $('#admin-content').innerHTML=critical.length?
   ...
   '<div class="empty-state"><h2>Estoque em dia</h2><p>Nenhum insumo com saldo abaixo de 10 na unidade cadastrada.</p></div>';
  return;
 }
