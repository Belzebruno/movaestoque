...
const store=process.env.DATABASE_URL?(await import('./postgres.mjs')).openPostgres():openDatabase();
...
server.listen(port,'0.0.0.0',()=>{
 ...
 console.log(`Banco: ${process.env.DATABASE_URL?'PostgreSQL / Neon':store.filename}\n`);
});
